<?php
namespace AuthDoctrin\Controller;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;

use AuthDoctrin\Entity\User;
...
use AuthDoctrin\Form\RegistrationForm;
use AuthDoctrin\Form\RegistrationFilter;
use AuthDoctrin\Form\ForgottenPasswordForm;
use AuthDoctrin\Form\ForgottenPasswordFilter;
...
//-		$form = $this->getRegistrationForm($entityManager, $user);
    ...
    public function confirmEmailAction()
    {
        ...
        try {
            $entityManager = $this->getServiceLocator()->get('doctrine.entitymanager.orm_default');
            $user = $entityManager->getRepository('AuthDoctrin\Entity\User')->findOneBy(array('usrRegistrationToken' => $token)); //
            $user->setUsrActive(1);
            ...
            $viewModel->setTemplate('auth-doctrin/registration/confirm-email-error.phtml');
        }
        return $viewModel;
    }
    ...
    public function forgottenPasswordAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                $entityManager = $this->getServiceLocator()->get('doctrine.entitymanager.orm_default');
                $user = $entityManager->getRepository('AuthDoctrin\Entity\User')->findOneBy(array('usrEmail' => $usrEmail)); //
