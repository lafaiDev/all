...
use AuthDoctrin\Entity\User; // only for the filters
use AuthDoctrin\Form\LoginForm;       // <-- Add this import
use AuthDoctrin\Form\LoginFilter;
...
class IndexController extends AbstractActionController
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('AuthDoctrin\Entity\User')->findAll();
